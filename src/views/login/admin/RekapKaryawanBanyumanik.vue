          ...
          <b-row>
            <b-col md="12" style="margin-top : 30px; margin-bottom: 30px">
              <h3 class="text-center m-t-0 m-b-0">
                <strong>DATA ABSENSI KARYAWAN BANYUMANIK</strong>
              </h3>
            </b-col>
          </b-row>
      ...
      axios
        ...
        .then((res) => {
          ...
          res.data.respon.forEach((element, index) => {
            if (res.data.respon[index].cabangKaryawan == "Banyumanik") {
